 ...
 *
 */
if ( ! class_exists( 'OVIC_Field_color' ) ) {
	class OVIC_Field_color extends OVIC_Fields
	{
		...
		public function render()
		{
			...
			echo '<input type="text" name="' . $this->field_name() . '" value="' . $this->value . '" class="ovic-color"' . $default_attr . $this->field_attributes() . '/>';
