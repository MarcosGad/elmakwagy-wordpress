	...
	class OVIC_Field_sorter extends OVIC_Fields
	{
		...
		public function render()
		{
			$args = wp_parse_args( $this->field, array(
					'disabled'       => true,
					'enabled_title'  => esc_html__( 'Enabled', 'ovic-addon-toolkit' ),
					'disabled_title' => esc_html__( 'Disabled', 'ovic-addon-toolkit' ),
				)
			);
			...
			echo ( $args['disabled'] ) ? '<div class="ovic-modules">' : '';

			echo ( !empty( $args['enabled_title'] ) ) ? '<div class="ovic-sorter-title">' . $args['enabled_title'] . '</div>' : '';
			...
			if ( $args['disabled'] ) {
				...
				echo ( !empty( $args['disabled_title'] ) ) ? '<div class="ovic-sorter-title">' . $args['disabled_title'] . '</div>' : '';
