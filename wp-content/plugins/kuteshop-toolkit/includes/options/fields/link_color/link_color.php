 ...
 *
 */
if ( !class_exists( 'OVIC_Field_link_color' ) ) {
	class OVIC_Field_link_color extends OVIC_Fields
	{
		...
		public function render()
		{
			...
			$color_props = array(
				...
				'hover'   => esc_html__( 'Hover', 'ovic-addon-toolkit' ),
				'active'  => esc_html__( 'Active', 'ovic-addon-toolkit' ),
				'visited' => esc_html__( 'Visited', 'ovic-addon-toolkit' ),
				'focus'   => esc_html__( 'Focus', 'ovic-addon-toolkit' ),
			);
			...
			foreach ( $color_props as $color_prop_key => $color_prop_value ) {
				if ( !empty( $args[$color_prop_key] ) ) {
					...
					echo '<div class="ovic--left ovic-field-color">';
					echo '<div class="ovic--title">' . $color_prop_value . '</div>';
					echo '<input type="text" name="' . $this->field_name( '[' . $color_prop_key . ']' ) . '" value="' . $value[$color_prop_key] . '" class="ovic-color"' . $default_attr . $this->field_attributes() . '/>';
					echo '</div>';
				}
			}
