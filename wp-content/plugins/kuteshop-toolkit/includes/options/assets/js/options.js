...
(function ( $, window, document, undefined ) {
    ...
    OVIC.helper = {
        ...
        remove_cookie: function ( name, path, domain, secure ) {
            OVIC.helper.set_cookie( name, '', -1000, path, domain, secure );
        },
    };
    ...
    $.fn.ovic_nav_options = function () {
        return this.each( function () {
            ...
            $( window ).on( 'hashchange ovic_hash_change', function () {
    ...
    $.fn.ovic_nav_metabox = function () {
        return this.each( function () {
            ...
            $links.on( 'click', function ( e ) {
                ...
                OVIC.helper.set_cookie( 'ovic-last-metabox-tab-' + post_id + '-' + unique_id, section_id );
            ...
            var get_cookie = OVIC.helper.get_cookie( 'ovic-last-metabox-tab-' + post_id + '-' + unique_id );
    ...
    $.fn.ovic_dependency = function () {
        return this.each( function () {
            ...
            var $this     = $( this ),
                ruleset   = $.ovic_deps.createRuleset(),
                depends   = [],
                is_global = false;
            ...
            if ( depends.length ) {
                ...
                if ( is_global ) {
                    $.ovic_deps.enable( OVIC.vars.$body, ruleset, depends );
                } else {
                    $.ovic_deps.enable( $this, ruleset, depends );
                }
        ...
        return this.each( function () {
            ...
            $reset.on( 'click', function ( e ) {
                ...
                if ( OVIC.vars.is_confirm ) {
                    ...
                    base.notification( window.ovic_vars.i18n.reset_notification );
            ...
            $import.on( 'click', function ( e ) {
                ...
                if ( OVIC.vars.is_confirm ) {
                    ...
                    base.notification( window.ovic_vars.i18n.import_notification );

                    window.wp.ajax.post( 'ovic-import', {
                        unique: $import.data( 'unique' ),
                        nonce: $import.data( 'nonce' ),
                        import_data: $this.find( '.ovic-import-data' ).val()
                    } ).done( function ( response ) {
                        window.location.reload( true );
                    } ).fail( function ( response ) {
                        alert( response.error );
    ...
    $.fn.ovic_field_group = function () {
        return this.each( function () {
            ...
            $group.children( '.ovic-cloneable-add' ).on( 'click', function ( e ) {
                ...
                $cloned_item.find( '.ovic-data-wrapper' ).each( function () {
            ...
            var event_clone = function ( e ) {
                ...
                var $this           = $( this ),
                    ...
                    cloned_regex    = new RegExp( '(' + OVIC.helper.preg_quote( field_id ) + ')\\[(\\d+)\\]', 'g' );

                $cloned_content.find( '.ovic-data-wrapper' ).each( function () {
                    var $this = $( this );
                    $this.attr( 'data-unique-id', $this.attr( 'data-unique-id' ).replace( cloned_regex, field_id + '[' + ($parent.index() + 1) + ']' ) );
                } );

                var $cloned = $( '<div class="ovic-cloneable-item" />' );
                    ...
                    window.wp.ajax.post( 'ovic-get-icons', {
                        ...
                        $nav.on( 'click', 'a', function ( e ) {
                            ...
                            if ( icon.hasClass( 'fa-folder' ) ) {
                                ...
                                other.find( 'i' ).removeClass( 'fa-folder-open' ).addClass( 'fa-folder' );
    ...
    $.fn.ovic_field_repeater = function () {
        return this.each( function () {
            ...
            var event_clone = function ( e ) {
                ...
                var $cloned = $( '<div class="ovic-repeater-item" />' );
                ...
                $cloned.children( '.ovic-repeater-content' ).ovic_reload_script();
    ...
    $.fn.ovic_field_spinner = function () {
        return this.each( function () {
            ...
            $input.spinner( {
                ...
                create: function ( event, ui ) {
                    if ( $unit.length ) {
                        $this.find( '.ui-spinner-up' ).after( '<span class="ui-button-text-only ovic--unit">' + $unit + '</span>' );
                    }
                },
    ...
    $.fn.ovic_field_upload = function () {
        return this.each( function () {
            ...
            var $this          = $( this ),
                ...
                $upload_button = $this.find( '.ovic--button' ),
                $remove_button = $this.find( '.ovic--remove' ),
                $preview       = $this.find( '.ovic--preview' ),
                $extensions    = [ 'jpg', 'gif', 'png', 'svg', 'jpeg' ],
                $title         = $upload_button.data( 'frame-title' ),
                $button        = $upload_button.data( 'insert-title' ),
                $library       = $upload_button.data( 'library' ) && $upload_button.data( 'library' ).split( ',' ) || '',
                wp_media_frame;
            ...
            $input.on( 'change keyup', function ( e ) {
                ...
                if ( $preview.length ) {
                    if ( $value && $.inArray( $ext, $extensions ) > -1 ) {
                        $preview.removeClass( 'hidden' );
                        $img.attr( 'src', $value );
                    } else {
                        $preview.addClass( 'hidden' );
    ...
    $.fn.ovic_field_wp_editor = function () {
        return this.each( function () {
            ...
            var editor_on_change = function ( editor ) {
                editor.on( 'change', OVIC.helper.debounce( function () {
                    editor.save();
        ...
        return this.each( function () {
            ...
            if ( $form_warning.length ) {
                ...
                window.onbeforeunload = function () {
                    return (OVIC.vars.form_modified) ? true : undefined;
                };
                ...
                create: function () {
                    ...
                    var a8cIris             = $input.data( 'a8cIris' ),
                        $transparent_wrap   = $( '<div class="ovic--transparent-wrap">' +
                            ...
                            '<div class="ovic--transparent-button">transparent <i class="fa fa-toggle-off"></i></div>' +
            ...
            if ( is_sortable ) {
                ...
                $chosen_choices.sortable( {
                    ...
                    update: function ( e, ui ) {
                        ...
                        var $prev_select   = $this.parent().find( '.ovic-hidden-select' );
