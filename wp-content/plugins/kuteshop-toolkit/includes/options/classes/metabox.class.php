    ...
    class OVIC_Metabox extends OVIC_Abstract
    {
        ...
        public function add_meta_box_content( $post, $callback )
        {
            ...
            if ( !empty($args['show_restore']) ) {
                ...
                echo '        <span class="button ovic-button-restore">' . esc_html__('Restore',
                        'ovic-addon-toolkit') . '</span>';
                echo '        <span class="button ovic-button-cancel">' . sprintf('<small>( %s )</small> %s',
                        esc_html__('update post for restore ', 'ovic-addon-toolkit'),
                        esc_html__('Cancel', 'ovic-addon-toolkit')) . '</span>';
                echo '    </label>';
                echo '</div>';
            }
                                    ...
                                    if ( !empty($field['id']) ) {
                                        ...
                                        if ( !empty($field['validate']) ) {
                                            ...
                                            if ( function_exists($validate) ) {
                                                ...
                                                $has_validated  = call_user_func($validate,
                                                    array( 'value' => $value_validate, 'field' => $field ));
                                                if ( !empty($has_validated) ) {
                                                    $meta_value            = get_post_meta($post_id, $request_key,
                                                        true);
