<?php
/**
 * Kuteshop WooCommerce Adjacent Products Class
 *
 * @package  kuteshop
 * @since    2.4.3
 */
...
if ( !class_exists( 'Kuteshop_WooCommerce_Adjacent_Products' ) ) :

	/**
	 * The Kuteshop WooCommerce Adjacent Products Class
	 */
	class Kuteshop_WooCommerce_Adjacent_Products
	{
		/**
		...
		private function query_wc()
		{
			...
			$products = wc_get_products( apply_filters( 'kuteshop_woocommerce_adjacent_query_args', $args ) );
