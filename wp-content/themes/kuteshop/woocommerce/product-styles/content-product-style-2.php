...
add_action( 'woocommerce_after_shop_loop_item_title', 'kuteshop_group_flash', 10 );
?>
    <div class="product-inner">
		...
		?>
        <div class="product-countdown default">
...
<?php
remove_action( 'woocommerce_after_shop_loop_item_title', 'kuteshop_group_flash', 10 );
